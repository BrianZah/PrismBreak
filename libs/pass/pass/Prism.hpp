...
namespace pass{
  ...
  public:
    ...
    const bool& getCalculateVisibility() const;
    void setCalculateVisibility(const bool& calculateVisibility);
  ...
  private:
    ...
    glPP::Buffer mUboNormals;
    glPP::Buffer mUboTileCenters;
    mutable glPP::Buffer mModelParameters;
    bool mScaleByWeight;

    Metric mMetric = variance;
    Rendering mRendering = mip;
    mutable glPP::Texture<GL_TEXTURE_1D> mIndexArray;
    ...
    bool mCalculateVisibility = true;

    glPP::Texture<GL_TEXTURE_2D> mFont;
    glPP::Texture<GL_TEXTURE_1D> mBookmarks;
    glPP::Texture<GL_TEXTURE_2D> mComponents;
    glPP::Texture<GL_TEXTURE_1D> mAttributes;
    mutable glPP::Texture<GL_TEXTURE_2D> mMetrics;
    mutable glPP::Texture<GL_TEXTURE_3D> mOverlap;
    mutable glPP::Texture<GL_TEXTURE_1D> mNumPixels;
    mutable glPP::Texture<GL_TEXTURE_2D> mOverlapNew;
    glPP::Texture<GL_TEXTURE_1D> mUIElement;

#ifndef GLPP_FRAMEBUFFER_HPP
#define GLPP_FRAMEBUFFER_HPP
...
namespace glPP{
  ...
  public:
    ...
    inline void attach(const glPP::Texture<GL_TEXTURE_1D>& texture, const GLenum& attachment, const GLint& level = 0);
    inline void attach(const glPP::Texture<GL_TEXTURE_2D>& texture, const GLenum& attachment, const GLint& level = 0);
    inline void attach(const glPP::Texture<GL_TEXTURE_2D_MULTISAMPLE>& texture, const GLenum& attachment, const GLint& level = 0);
    template<std::convertible_to<GLenum>... glEnum>
    inline void drawBuffers(const glEnum& ...drawBuffers) const;
    inline void attach(const glPP::Renderbuffer& renderbuffer, const GLenum& attachment);
  ...
  inline void Framebuffer::attach(const glPP::Texture<GL_TEXTURE_1D>& texture, const GLenum& attachment, const GLint& level) {
  ...
  inline void Framebuffer::attach(const glPP::Texture<GL_TEXTURE_2D>& texture, const GLenum& attachment, const GLint& level) {
    glNamedFramebufferTexture(mId, attachment, texture.mId, level);
    //mDrawBuffers.push_back(attachment);
    //glNamedFramebufferDrawBuffer(mId, attachment);
  }
  inline void Framebuffer::attach(const glPP::Texture<GL_TEXTURE_2D_MULTISAMPLE>& texture, const GLenum& attachment, const GLint& level) {
    glNamedFramebufferTexture(mId, attachment, texture.mId, level);
    //mDrawBuffers.push_back(attachment);
    //glNamedFramebufferDrawBuffer(mId, attachment);
  }
  ...
  //}
  inline void Framebuffer::attach(const glPP::Renderbuffer& renderbuffer, const GLenum& attachment) {
